...
export const Signup = () => {
    ...
    const { loadingLogin, googlelogin, diagramxsignup, loadingDiagramxsignup } = useAuth();
    ...
    const signup = async () => {
        try {
            const message = await diagramxsignup(username, useremail, userpassword);
                            ...
                            <div className="flex flex-col gap-6">
                                <FieldGroup>
                                    <div className="flex flex-col items-center gap-1">
                                        <h1 className="text-3xl font-bold text-cyan-500">Create Account</h1>
                                    </div>
                                    <Field>
                                        <FieldLabel htmlFor="username">Username</FieldLabel>
                                        <Input id="username" onChange={(e) => setusername(e.target.value)} value={username} placeholder="Enter Username" />
                                    </Field>
                                    <Field>
                                    ...
                                    <Field>
                                        ...
                                        <Input id="confirmpassword" onChange={(e) => setconfirmpassword(e.target.value)} value={confirmpassword} placeholder="Confirm Password" type="password" />
                                    </Field>
                                    <Field>
                                        <Button type="button" onClick={signup} className="bg-cyan-500 hover:bg-cyan-600">{loadingDiagramxsignup ? <Spinner /> : "Signup"}</Button>
                                    </Field>
                                    ...
                                    <Field>
                                        <Button onClick={googleauth} variant="outline" type="button">
                                            ...
                                            {loadingLogin ? "Authenticating" : "Sign Up with Google"}
                                        </Button>
