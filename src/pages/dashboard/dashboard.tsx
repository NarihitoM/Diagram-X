...
export const Dashboard = () => {
    ...
    const { Workspacedata, workspacefetch, workspacecreate, loadingworkspacecreate, loadingfetchworkspace, loadingworkspacedelete, workspacedelete } = useWorkspace();
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-3">
                <h1 className="text-4xl font-bold"><span className="text-cyan-500">D</span>ashboard</h1>
                <h1 className="text-2xl text-gray-500 font-medium">Welcome back <span className="text-cyan-500">{username}</span>!</h1>
                <div className="flex flex-col justify-center  items-center border rounded-lg border-dashed border-gray-400 w-full h-50">
                    <h1 className="text-3xl font-medium">Create A New Space</h1>
                    <Button className="bg-cyan-500 mt-3 text-white hover:bg-cyan-700" onClick={() => setOpen(true)}>Create Space</Button>
                </div>
